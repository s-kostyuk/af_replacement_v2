...
class _LEAF(torch.autograd.Function):
    @staticmethod
    def _forward_old_torch(ctx: FunctionCtx, u, p1, p2, p3, p4) -> Any:
        ctx.save_for_backward(u, p1, p2, p3, p4)
        return _LEAF._forward_new_torch(u, p1, p2, p3, p4)

    @staticmethod
    def _forward_new_torch(u, p1, p2, p3, p4) -> Any:
    ...
    def forward(*args, **kwargs) -> Any:
        if torch.__version__[0] == '1':
            return _LEAF._forward_old_torch(*args, **kwargs)
        else:
            return _LEAF._forward_new_torch(*args, **kwargs)
