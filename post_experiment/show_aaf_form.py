...
def visualize_afs(net_info: NetInfo, max_rows: int = 2, bw=False,
    ...
    fig = plt.figure(tight_layout=tight_layout, figsize=(6, height))
...
def main():
    ...
    for n, ds in net_ds_combinations:
        nets_nds = [
            NetInfo(n, "ahaf", ds, "ReLU", 100, patched=False, fine_tuned=False, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "ahaf", ds, "SiLU", 100, patched=False, fine_tuned=False, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "ahaf", ds, "ReLU", 100, patched=True, fine_tuned=False, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "ahaf", ds, "SiLU", 100, patched=True, fine_tuned=False, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "ahaf", ds, "ReLU", 150, patched=True, fine_tuned=True, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "ahaf", ds, "SiLU", 150, patched=True, fine_tuned=True, dspu4=False, p24sl=False, opt_name=opt),

            NetInfo(n, "fuzzy_ffn", ds, "Tanh", 100, patched=False, fine_tuned=False, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "fuzzy_ffn", ds, "Sigmoid", 100, patched=False, fine_tuned=False, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "fuzzy_ffn", ds, "Tanh", 100, patched=True, fine_tuned=False, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "fuzzy_ffn", ds, "Sigmoid", 100, patched=True, fine_tuned=False, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "fuzzy_ffn", ds, "Tanh", 150, patched=True, fine_tuned=True, dspu4=False, p24sl=False, opt_name=opt),
            NetInfo(n, "fuzzy_ffn", ds, "Sigmoid", 150, patched=True, fine_tuned=True, dspu4=False, p24sl=False, opt_name=opt),
        ]
