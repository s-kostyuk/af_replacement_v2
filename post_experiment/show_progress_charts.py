...
def main():
    ...
    for n, ds in net_ds_combinations:
        ...
        visualize(
            ...
            bw=black_white, omit_af_names=True
        )
        ...
        visualize(
            n, ds, f"lus_{opt}", alternate_els(relu_comparison, silu_comparison),
            None if omit_all_captions else f"{n} on {ds} - Linear Units",
        ...
        visualize(
            n, ds, f"bfs_{opt}", alternate_els(tanh_comparison, sigmoid_comparison),
            None if omit_all_captions else f"{n} on {ds} - Bound Functions",
            bw=black_white, omit_af_names=False
        )
